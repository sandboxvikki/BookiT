                ...
                <?php while($row = $pending->fetch_assoc()): ?>
                    <div style="margin:18px 0;border-bottom:1px solid #eee;padding-bottom:10px;">
                        ...
                        <div style="font-size:14px;margin:4px 0;">
                            ...
                            <span style="margin-left:12px;">🚗 <?php echo htmlspecialchars($row['vehicle_name'] . " (" . $row['license_plate'] . ")"); ?></span>
                        </div>
                        ...
                        <form method="post" action="manage_requests.php" style="display:inline;">
                            ...
                            <button type="submit" name="action" value="reject" class="modal-cancel-btn">Reject</button>
                        </form>
                    </div>
                <?php endwhile; ?>
            </div>
